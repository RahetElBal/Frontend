export const fr = {
  ...
  errors: {
    ...
    db: {
      ...
      unknown: "Erreur de base de donn?es. Veuillez réessayer.",
    },
  },
  ...
  landing: {
    ...
    heroImageAlt: "Portrait d'une femme algerienne dans un salon moderne",
    nav: {
      discover: "Decouvrir",
      services: "Services",
      pricing: "Tarifs",
    ...
    badge: "100% Algerien",
    titleLine1: "Elevez la gestion",
    titleLine2: "de votre salon",
    description:
      "Beautiq centralise CRM, agenda, ventes et marketing pour les salons de beaute en Algerie. Gerez web et mobile depuis une seule plateforme.",
    ctaLogin: "Acceder a la connexion",
    ctaMobile: "App mobile",
    highlights: {
      growthLabel: "croissance du CA apres digitalisation",
      costLabel: "reduction des couts avec un process unifie",
      dzLabel: "plateforme concue pour le marche algerien",
    },
    features: {
      badge: "Operer plus vite",
      crmTitle: "CRM clients",
      crmDescription: "Fiches clients, historique et preferences centralises.",
      agendaTitle: "Agenda intelligent",
      agendaDescription: "Rendez-vous, disponibilites et rappels automatiques.",
      cashTitle: "Caisse + marketing",
      cashDescription: "Paiements, campagnes et performance en temps reel.",
    },
    pricing: {
      badge: "Tarifs",
      title: "Offres pour chaque niveau de croissance",
      launchNote:
        "Partenariat lancement: les 10 premiers partenaires payants ont 2 ans d'abonnement inclus.",
    ...
    plans: {
      standard: {
        name: "Standard",
        subtitle: "Par offre",
        item1: "Admin user inclus",
        item2: "5 sieges pour l'application mobile",
        item3: "Mise en place rapide",
        item4: "Support de demarrage",
      },
      pro: {
        name: "Pro",
        subtitle: "Par offre",
        item1: "Tout Standard +",
        item2: "Automatisations marketing avancees",
        item3: "Publication Instagram et TikTok",
        item4: "Analytics avances",
        item5: "Roles et permissions avances",
        item6: "Support prioritaire",
      },
      allIn: {
        name: "All-In",
        subtitle: "Projet complet",
        item1: "SaaS installe dans le salon",
        item2: "Deploiement en intranet",
        item3: "Support technique complet",
        item4: "Accompagnement personnalise",
      },
    },
    algeria: {
      badge: "Identite algerienne",
      title: "Concu pour les salons algeriens",
      description:
        "Tarification locale en DA, workflows adaptes au terrain et accompagnement de proximite.",
    },
    dzPioneer:
    ...
    footer: {
      rights: "(c) 2026 Beautiq. Tous droits reserves.",
      terms: "Conditions",
  ...
  supportReport: {
    ...
    description:
      "Envoyez une demande de support structuree directement au support Beautiq.",
    routing: {
      title: "Routage et priorite",
      currentOffer: "Offre actuelle :",
      predictedPriority: "Priorite estimee :",
      description:
        "Les rapports sont envoyes a {{email}} et classes avec un badge d'offre et une priorite.",
    ...
    types: {
      ...
      bug_report: {
        ...
        description: "Erreur inattendue ou parcours casse.",
      },
      billing: {
        label: "Facturation",
      ...
      account_access: {
        ...
        description: "Problemes de connexion, acces ou permissions.",
      },
      incident: {
        label: "Incident critique",
        description: "Interruption urgente du service necessitant une reponse rapide.",
      },
      feature_request: {
        label: "Demande de fonctionnalite",
        description: "Proposer une amelioration produit.",
      },
      other: {
        label: "Autre",
    ...
    form: {
      ...
      typePlaceholder: "Selectionnez un type de rapport",
      subjectLabel: "Sujet",
      subjectPlaceholder: "Resume court de votre probleme",
      messageLabel: "Message",
      messagePlaceholder:
        "Decrivez ce qui s'est passe, les etapes pour reproduire et le resultat attendu",
      messageCount: "{{count}}/4000",
      includeDiagnosticsLabel: "Inclure les diagnostics",
      includeDiagnosticsDescription:
        "Le contexte navigateur/utilisateur aide le support a reproduire le probleme plus vite.",
      submit: "Envoyer le rapport",
      sending: "Envoi...",
    },
    validation: {
      subjectMin: "Le sujet doit contenir au moins 4 caracteres",
      messageMin: "Le message doit contenir au moins 20 caracteres",
    },
    toasts: {
      success: "Rapport envoye - Ticket {{ticketId}}",
      error: "Echec de l'envoi du rapport",
    },
  },
  plans: {
    badge: "Plan : {{plan}}",
