export const fr = {
  ...
  staff: {
    ...
    noStaffDescription: 'Ajoutez des membres depuis le panneau d\'administration pour gérer leurs horaires.',
  ...
  promotions: {
    ...
    noPromotionsDescription: 'Créez votre première promotion pour attirer plus de clients.',
    ...
    firstTimeOnlyDescription: 'Seuls les nouveaux clients peuvent utiliser cette promotion',
    birthdayOnly: 'Mois d\'anniversaire uniquement',
    birthdayOnlyDescription: 'Uniquement les clients dont c\'est le mois d\'anniversaire',
  ...
  salonSettings: {
    ...
    appointmentConfirmationDescription: 'Envoyer une confirmation lors de la réservation',
