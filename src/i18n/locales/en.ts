...
export const en = {
  ...
  agenda: {
    ...
    unpaidTotalToday: "Unpaid total today",
    ...
    walkInNamePlaceholder: "e.g. Sara Ali",
  ...
  sales: {
    ...
    paymentsDescription: "Payments recorded from appointments",
    newSale: "New Sale",
    ...
    refund: "Refund",
    refundConfirm: "Confirm refund for this payment?",
    refundSuccess: "Payment refunded",
    refundError: "Unable to refund this payment",
    complete: "Complete",
    paymentStatus: "Payment status",
    paidBy: "Paid by",
    selectClient: "Select a client",
  ...
  analytics: {
    ...
    noDataDescription:
      "Start recording sales and appointments to see your analytics.",
  },
  ...
  salon: {
    ...
    noSalonsDescription:
      "You don't have access to any salon. Contact your administrator.",
  ...
  staff: {
    ...
    noStaffDescription:
      "Add staff members from the admin panel to manage their schedules.",
  ...
  admin: {
    ...
    services: {
      ...
      selectSalonFirst: "Select a salon first",
