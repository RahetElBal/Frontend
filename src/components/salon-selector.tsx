...
export function SalonSelector({ onSelect }: SalonSelectorProps) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent-pink/5 to-accent-blue/5">
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent-pink/5 to-accent-blue/5 p-4">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">{t('salon.selectSalonDescription')}</p>
        </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-accent-pink to-accent-blue flex items-center justify-center text-white">
                    {salon.logo ? (
                      <img src={salon.logo} alt={salon.name} className="h-14 w-14 rounded-xl object-cover" />
                    ) : (
